...
LBP.prototype.addInfoControl = function(vid, pid) {
	...
	var content_default = this.getTranslation("Info_content_default_player", [this.options.infoUrl, this.version])+" &nbsp;&nbsp;&copy; Copyright 2010-"+(new Date()).getFullYear()+", All Rights Reserved.";
